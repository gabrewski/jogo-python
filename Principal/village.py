...
def village(window):
    ...
    while True:
        ...
        if key == ord('1'):
            shop.open_weapon_shop(window, player_level=1)  # Ajuste o player_level conforme necessário
        elif key == ord('2'):
            shop.open_armor_shop(window, player_level=1)
        elif key == ord('3'):
            shop.open_potion_shop(window, player_level=1)
